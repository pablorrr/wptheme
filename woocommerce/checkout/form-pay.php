	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'wptheme' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'wptheme' ); ?></th>
			</tr>
		</thead>
		<tbody>
